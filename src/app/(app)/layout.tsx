...
export default async function AppLayout({
  ...
  return (
    ...
    <div className="flex min-h-dvh">
      <a
        href="#main"
        className="bg-primary text-primary-foreground sr-only z-50 rounded-md px-3 py-2 focus:not-sr-only focus:absolute focus:end-4 focus:top-2"
      >
        דילוג לתוכן
      </a>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main id="main" className="flex-1 p-4 pb-20 md:p-6 md:pb-6">
          {children}
        </main>
      </div>
